...
private static FrenchNumberToWords instance;   

public static FrenchNumberToWords getInstance(){
if(instance==null){
    instance=new FrenchNumberToWords();
}
return instance;
}     
  ...
  //  System.out.println("snumber="+snumber);
    ...
    int lesMille = Integer.parseInt(snumber.substring(9,12));
     ...
     int lesVerguile= Integer.parseInt(snumber.substring(13,15));
 //System.out.println("lesVerguile="+lesVerguile);
    ...
    if(lesVerguile>0)
resultat =  resultat+" vérguile "+convertZeroToHundred(lesVerguile);
    return resultat;
  }
 ...
 //public static void main(String[] args) {
  /*  System.out.println("*** " + FrenchNumberToWords.convert(0));
    ...
    System.out.println("*** " + FrenchNumberToWords.convert(19.00));
    System.out.println("*** " + FrenchNumberToWords.convert(21.00));
    System.out.println("*** " + FrenchNumberToWords.convert(28.01));
    System.out.println("*** " + FrenchNumberToWords.convert(71.2));
    System.out.println("*** " + FrenchNumberToWords.convert(72.62));
    System.out.println("*** " + FrenchNumberToWords.convert(80.1));
