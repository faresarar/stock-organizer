...
public class Search_Item extends javax.swing.JPanel {
    ...
    private void setData(DataSearch data) {
        ...
        lbText.setText(data.getText().getDésignation());
        if (data.isStory()) {
            lbText.setForeground(new Color(29, 106, 205));
//            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("search/icon/time.png")));
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(lbText, javax.swing.GroupLayout.DEFAULT_SIZE, 391, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lbRemove, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
