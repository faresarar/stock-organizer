...
public class Message extends SweetAlert {
 ...
 Color clr=new Color(255,0,0);
     ...
     */
    public Message(java.awt.Frame parent, boolean modal,String imageLocation,String ms1,String ms2,Color jLabel2Color) {
        super(parent, modal);
        image=imageLocation;
        msg1=ms1;
        msg2=ms2;
    ...
    private void initComponents() {
        ...
        button1 = new sweet_alert.Button();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource(image))); // NOI18N
    ...
    public static void main(String args[]) {
      ...
      /*  java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Message dialog = new Message(new javax.swing.JFrame(), true,image);
    ...
    private sweet_alert.Button button1;
