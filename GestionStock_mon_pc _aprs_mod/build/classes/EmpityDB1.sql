...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 21 nov. 2024 à 10:59
...
CREATE TABLE `achat` (
  `num_bon_réception` int(255) NOT NULL DEFAULT 1,
...
('Rais market', '', '', '', '', '', '', '', '', 1, 'Alimentation général', '\nmerci pour votre visite\nتابعونا على الفايسبوك\n\n', 0);
...
--
ALTER TABLE `client`
  MODIFY `id_c` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `fournisseur`
  MODIFY `id_f` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `versement_fournisseur`
  MODIFY `num_versement` int(222) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
...
--
ALTER TABLE `achat`
  ADD CONSTRAINT `idpro` FOREIGN KEY (`id_produit`) REFERENCES `produit` (`id_produit`) ON DELETE CASCADE ON UPDATE CASCADE;
